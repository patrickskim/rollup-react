(function (factory) {
	...
	*/
	...
	var styles = {"App":"App-module_App__35ugX","chart":"App-module_chart__3n8IU","chart-title":"App-module_chart-title__aOJDh"};
	...
	var styles$1 = {"Orderbook":"Orderbook-module_Orderbook__2elDq","asks":"Orderbook-module_asks__2L9tp","bids":"Orderbook-module_bids__qIlm4","avg":"Orderbook-module_avg__1MpAS"};
	...
	var Orderbook = function Orderbook(props) {
	  var orders = props.orders,
	      viewLimit = props.viewLimit;

	  function renderRows(orders) {
	    var viewLimit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5;
	    var rows = [];
	    var prev = {};
	  ...
	  var bids = renderRows(orders.bids, viewLimit);
	  var asks = renderRows(orders.asks, viewLimit);
	  return react.createElement("table", {
	    className: styles$1.Orderbook
	    ...
	    className: styles$1.bids
	  }, bids.reverse()), react.createElement("tr", {
	    className: styles$1.avg
	  }, react.createElement("td", {
	    colspan: 3
	  }, fmt$(avg))), react.createElement("tbody", {
	    className: styles$1.asks
	  }, asks));
	};

	Orderbook.propTypes = {
	  orders: reactProptypes.shape({
	    asks: reactProptypes.arrayOf(reactProptypes.shape({
	      quantity: reactProptypes.number.isRequired,
	      price: reactProptypes.number.isRequired
	    })).isRequired,
	    bids: reactProptypes.arrayOf(reactProptypes.shape({
	      quantity: reactProptypes.number.isRequired,
	      price: reactProptypes.number.isRequired
	    })).isRequired
	  }),
	  viewLimit: reactProptypes.number
	};
	...
	function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: "pollData",
	    value: function () {
	      var _pollData = _asyncToGenerator(
	      /*#__PURE__*/
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                interval = _args.length > 0 && _args[0] !== undefined ? _args[0] : 1000;
	                URL = 'https://exchange.itbit.com/api/feeds/orderbook/XBTUSD';
	                _context.next = 4;
	                return fetch(URL);
	      ...
	      function pollData() {
	        return _pollData.apply(this, arguments);
	      }
	    ...
	    value: function render() {
	      ...
	      }, "Orderbook"), orders ? react.createElement(Orderbook, {
	        orders: orders
	      }) : 'Loading'));
	    }
	  }]);
